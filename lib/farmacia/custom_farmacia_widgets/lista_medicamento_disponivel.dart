...
class _InteresseAutoCompletarState extends State<InteresseAutoCompletar> {
  var cnpjController = new MaskedTextController(mask: '000');
  String currentText = "";
                      ...
                      showDialog(context: context,
                          builder: (context)=>
                              AlertDialog(
                                ...
                                content: Text(
                                    "Deseja adicionar o medicamento $text na sua lista de disponibilidade?"),
                                shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(12)
                                ),
                                actions: <Widget>[
                                    ...
                                    Navigator.pop(context);
                                      ...
                                      if(r.statusCode == 200 || r.statusCode == 204){
                                        ...
                                        _scaffoldKey.currentState.showSnackBar(
                                          SnackBar(content: Text("Disponibilidade cadastrada com sucesso!"),
